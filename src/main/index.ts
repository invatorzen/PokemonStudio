...
import { registerReadHiddenGrotto, registerWriteHiddenGrotto } from '@src/backendTasks/hiddenGrotto';
import { registerReadOutfitConfig, registerSaveOutfitConfig } from '@src/backendTasks/outfitConfig';
import { registerReadCraftingConfig, registerSaveCraftingConfig } from '@src/backendTasks/craftingConfig';
import { registerReadMapSettingsConfig, registerSaveMapSettingsConfig } from '@src/backendTasks/mapSettingsConfig';
import { registerReadTypeChartsConfig, registerSaveTypeChartsConfig } from '@src/backendTasks/typeChartsConfig';
import { registerReadSosBattle, registerWriteSosBattle } from '@src/backendTasks/sosBattle';
import { registerReadAmbientCriesConfig, registerSaveAmbientCriesConfig } from '@src/backendTasks/ambientCriesConfig';
import { registerReadCriticalHealthAudioConfig, registerSaveCriticalHealthAudioConfig } from '@src/backendTasks/criticalHealthAudioConfig';
import { registerApplyDataPack, registerCheckDataPackEnv } from '@src/backendTasks/applyDataPack';
import { registerWriteRMXPSwitchNames } from '@src/backendTasks/writeRMXPSwitchNames';
import { registerReadUmbraSwitchRegistry } from '@src/backendTasks/readUmbraSwitchRegistry';
...
import { registerReadEventDialogue } from '@src/backendTasks/readEventDialogue';
...
registerReadEventDialogue(ipcMain);
...
registerReadHiddenGrotto(ipcMain);
registerReadOutfitConfig(ipcMain);
registerSaveOutfitConfig(ipcMain);
registerWriteHiddenGrotto(ipcMain);
registerReadSosBattle(ipcMain);
registerReadAmbientCriesConfig(ipcMain);
registerSaveAmbientCriesConfig(ipcMain);
registerReadCriticalHealthAudioConfig(ipcMain);
registerSaveCraftingConfig(ipcMain);
registerReadCraftingConfig(ipcMain);
registerSaveMapSettingsConfig(ipcMain);
registerReadMapSettingsConfig(ipcMain);
registerSaveTypeChartsConfig(ipcMain);
registerReadTypeChartsConfig(ipcMain);
registerSaveCriticalHealthAudioConfig(ipcMain);
registerApplyDataPack(ipcMain);
registerCheckDataPackEnv(ipcMain);
registerWriteRMXPSwitchNames(ipcMain);
registerReadUmbraSwitchRegistry(ipcMain);
registerWriteSosBattle(ipcMain);
